...
SerializerApi::SerializerApi(std::uint32_t majorVersion, std::uint32_t minorVersion, const char* rootElementName)
    : mDocument(std::make_shared<tinyxml2::XMLDocument>()), mCurrentElement(*mDocument->NewElement(rootElementName)), mMajorVersion(majorVersion), mMinorVersion(minorVersion)
{
